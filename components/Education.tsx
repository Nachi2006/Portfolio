    ...
    <section id="education" className="py-24 bg-surface-muted/20 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-8">
          {/* Degree */}
          <div className="glass-card rounded-2xl p-7 border border-surface-border flex flex-col justify-between hover:border-white transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/10 border border-surface-border flex items-center justify-center shrink-0 text-white">
            ...
            <div className="flex flex-wrap items-center justify-between pt-6 mt-4 border-t border-surface-border">
              ...
              <span className="font-mono text-xs font-bold px-3 py-1 rounded-md bg-white text-black">
                CGPA {education.cgpa}
              </span>
            </div>
          </div>
          ...
          {certifications.map((cert, idx) => (
            <div key={idx} className="glass-card rounded-2xl p-7 border border-surface-border flex flex-col justify-between hover:border-white transition-all duration-300">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-white/10 border border-surface-border flex items-center justify-center shrink-0 text-white">
                  <Award size={22} />
                </div>
              ...
              {cert.link && (
                <div className="pt-6 mt-4 border-t border-surface-border">
                  <a 
                    href="https://drive.google.com/file/d/1aNbFo3jNAgfr-spPnge4JoaKcdNPvb-A/view?usp=drive_link"
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-flex items-center gap-1 text-xs font-mono text-text-primary hover:text-white hover:underline transition-all"
                  >
