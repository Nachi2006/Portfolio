    ...
    <div className="space-y-5">
      <div className="h-[60px] flex items-center">
        {active ? (
          ...
          <div className="w-full p-3 rounded-xl border border-transparent text-xs font-mono text-text-muted flex items-center gap-2">
            <Info size={13} className="shrink-0" />
            <span>Hover over a skill to see details...</span>
          </div>
        )}
      </div>
